...
A small demo blog built on [Jekyll](https://jekyllrb.com), the
[Ruby](https://www.ruby-lang.org) static-site generator. There is no
...
It starts from the [Chirpy](https://github.com/cotes2020/jekyll-theme-chirpy)
...
team section: a [Liquid](https://shopify.github.io/liquid/) include
